  ...
  const portfolioItems = [
    {
      ...
      description: "Engaging content that boosted client engagement by 300%",
      color: "from-purple-600 to-blue-600"
    },
    {
      title: "Brand Launch Poster",
      category: "Poster Design",
      description: "Eye-catching launch materials for a local business",
      color: "from-pink-600 to-orange-600"
    },
    {
      title: "Event Promotion",
      category: "Creative Design",
      description: "Complete promotional package for a community event",
      color: "from-green-600 to-teal-600"
    },
    {
      title: "Product Marketing",
      category: "Digital Campaign",
      description: "Strategic marketing that increased sales by 250%",
      color: "from-indigo-600 to-purple-600"
    },
    {
      title: "Festival Special",
      category: "Poster Design",
      description: "Festive designs that captured the celebration spirit",
  ...
  Connect & Grow
      ...
      <section id="portfolio" className="py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 md:mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Portfolio Showcase</h2>
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Explore some of our recent projects that helped businesses grow and succeed
            </p>
          </div>
          ...
          <div className="relative max-w-5xl mx-auto">
            <div className="relative overflow-hidden rounded-3xl">
              {portfolioItems.map((item, idx) => (
                ...
                >
                  <div className={`relative bg-gradient-to-br ${item.color} rounded-3xl overflow-hidden min-h-[400px] md:min-h-[500px] flex items-center justify-center`}>
                    ...
                    <div className="relative z-10 text-center px-6 md:px-12 py-12">
                      ...
                      <p className="text-lg md:text-xl text-gray-200 max-w-2xl mx-auto">{item.description}</p>
                    </div>
                  </div>
                </div>
              ))}
            ...
            <button
              onClick={prevSlide}
              className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full p-3 hover:bg-white/20 transition-all duration-300 z-20"
            >
              <ChevronLeft className="w-6 h-6" />
            </button>
            <button
              onClick={nextSlide}
              className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full p-3 hover:bg-white/20 transition-all duration-300 z-20"
            >
      ...
      <section id="contact" className="py-24 md:py-32 bg-white/5">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="bg-gradient-to-br from-blue-600/10 via-purple-600/10 to-pink-600/10 backdrop-blur-sm border border-white/10 rounded-3xl p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <button
                onClick={handleWhatsApp}
                className="group flex items-center justify-center space-x-3 bg-gradient-to-r from-green-600 to-green-500 text-white px-8 py-5 rounded-2xl font-semibold hover:shadow-lg hover:shadow-green-500/50 hover:scale-105 transition-all duration-300"
              >
                <Phone className="w-6 h-6" />
                <div className="text-left">
                  <div className="text-xs text-green-100">WhatsApp</div>
                  <div className="text-base">+91 8086790180</div>
                </div>
              </button>
              
              <button
                onClick={handleEmail}
                className="group flex items-center justify-center space-x-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-5 rounded-2xl font-semibold hover:shadow-lg hover:shadow-purple-500/50 hover:scale-105 transition-all duration-300"
              >
                <Mail className="w-6 h-6" />
                <div className="text-left">
                  <div className="text-xs text-purple-100">Email Us</div>
                  <div className="text-sm">muhdrabeehkv7902@gmail.com</div>
                </div>
              </button>
            </div>
            ...
            <div className="text-center pt-6 border-t border-white/10">
              ...
              <div className="flex justify-center space-x-6">
                <a href="https://www.instagram.com/conect_grow" className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-full p-3 hover:bg-white/10 hover:border-purple-500/50 transition-all duration-300">
                  <Instagram className="w-6 h-6 text-purple-400" />
                </a>
                {/* <a href="#" className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-full p-3 hover:bg-white/10 hover:border-blue-500/50 transition-all duration-300">
